...
- **Node details callout:** selecting a node opens `#graph-panel` as a card pinned beside that node, with an arrow pointing at it.
  ...
  - **Off-stage node:** the arrow hides while the card stays on the stage.
