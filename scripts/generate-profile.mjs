...
const sourceProxyBullet = '- Nginx reverse proxy (443/6000/5678), SSL/TLS, WebSocket proxying';
if (devopsStart < 0 || devopsLines.filter(line => line === sourceProxyBullet).length !== 1) {
