const works = [
  {
    id: 0,
    imgLink: "assets/works/movies-ai.jpeg",
    title: "Cinemotion",
    desc: "Cinemotion is an innovative movie and series recommendation app that employs AI to suggest personalized content based on your mood. This app is built using Next.js for the frontend, Tailwind CSS for styling, Lucide React for icons, Shadcn/ui for building components, and Zustand for state management.",
    category: "Next Js",
    demoLink: "https://movies-tv-app-with-ai.vercel.app/",
  },
  {
    id: 1,
